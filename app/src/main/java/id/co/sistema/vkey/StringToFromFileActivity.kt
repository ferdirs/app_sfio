...
class StringToFromFileActivity : AppCompatActivity(), VosWrapper.Callback , VGExceptionHandler {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        et_input_encrypt = findViewById(R.id.et_encrypt_txtfile)
        et_input_encrypt_password = findViewById(R.id.et_password_input)
        et_input_decrypt = findViewById(R.id.et_decrypt_password)
        et_input_oldpass = findViewById(R.id.et_oldpass)
        et_input_update_newpass = findViewById(R.id.et_passwordnewt)
        et_input_confrim_newpass = findViewById(R.id.et_password_confirm)

        bt_save_encrypt = findViewById(R.id.bt_save_encrypt)
        bt_save_decrypt = findViewById(R.id.bt_read_decrypt)
        bt_update_pass = findViewById(R.id.bt_updatepass)
    ...
    private fun dec(){
        ...
        try {
            val decString = SecureFileIO.decryptString(encryptedFilePath , password)
